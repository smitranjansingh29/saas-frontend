      ...
      <div className="about-us-content">
        ...
        <section className="additional-services">
          ...
          <div className="service-card">
            ...
            <p>
              We also offer application development services for web, mobile,
              SAP, and BI tools. Our experts are proficient in a wide range of
              programming languages and development frameworks. We can help our
              clients develop customized applications that are tailored to their
          ...
          <div className="service-card">
            ...
            <p>
              At our company, we are committed to providing exceptional service
              and support to our clients. We work closely with our clients to
              understand their business needs and provide solutions that meet
              their specific requirements. Contact us today to learn more about
              our services and how we can help your business succeed.
            </p>
          </div>
        </section>
      </div>
